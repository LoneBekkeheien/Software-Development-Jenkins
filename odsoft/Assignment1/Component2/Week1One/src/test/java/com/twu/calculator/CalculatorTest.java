...
public class CalculatorTest {
    ...
    @Test
    public void shouldReturnAThirdOfResult() {
      Calculator calculator = new Calculator();
      calculator.doOperation("add", 9);
      double actualResult = calculator.doOperation("third", 0);

      assertThat(actualResult, is(3.0));
    }

    @Test
    public void shouldAlsoReturnAThirdOfResult() {
      Calculator calculator = new Calculator();
      calculator.doOperation("add", 27);
      double actualResult = calculator.doOperation("third", 0);
