...
public class CalculatorTest {
    ...
    @Test
    public void shouldReturnCorrectValueWhenMultipliedByTwoCommandAreGiven(){
        Calculator calculator = new Calculator();
        calculator.doOperation("add", 10);

        double actualResult = calculator.doOperation("double", 0);

        assertThat(actualResult, is(20.0));

    }


    @Test
    public void shouldReturnCorrectValueWhenMultipliedByTwoCommandAreGiven1(){
        Calculator calculator = new Calculator();
        calculator.doOperation("add", 10);
    ...
    @Test
    public void shouldReturnCorrectValueWhenMultipliedByTwoCommandAreGiven2(){
        Calculator calculator = new Calculator();
        calculator.doOperation("add", 10);
