...
public class CalculatorTest {
    ...
    @Test
    public void shouldReturnCorrectValueWhenFirstCommandIsAddAndSecondCommandIsMultiplyByOperand() {
        Calculator calculator = new Calculator();
        calculator.doOperation("add", 2);

        double actualResult = calculator.doOperation("exponential", 2);
