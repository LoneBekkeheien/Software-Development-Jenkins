...
public class StudentsServiceImplJRETest extends TestCase {
	...
	public void testAddStudent() {
		Student student = new Student("0", "FisrtName", "LastName" , "Gender", "BirthDate");
	...
	public void testUpdateStudent() {
		...
		student.setFirstName("FirtsName_different");
		student.setLastName("LastName_different");
		student.setGender("Gender_different");
		student.setBirthDate("BirthDate_different");
	...
	public void testDeleteStudents() {		
		Student student = new Student("0", "FisrtName", "LastName" , "Gender", "BirthDate");
		Student student2 = new Student("0", "FisrtName", "LastName" , "Gender", "BirthDate");
		studentsServiceImpl.addStudent(student);
